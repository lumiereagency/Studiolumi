 ...
 * figure-eight path. Placeholder geometry until the studio's source logo
 * file (PNG/JPEG) is supplied; swap the `d` below for a traced version of
 * the real mark without altering how it's consumed elsewhere.
 */
